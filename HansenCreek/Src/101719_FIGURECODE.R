...
#pal <- choose_palette()
#pal(color_pa)
col <-function (n, h = c(260, 0), c. = c(80, 0), l = c(30, 90), power = c(1.5, 
                                                                          0), fixup = TRUE, gamma = NULL, alpha = 1, ...) 
{
  if (!is.null(gamma)) 
...
col.blue <- function (n, h = 235, c. = c(80, 0), l = c(30, 88), power = 1.54838709677419, 
...
col.green <- function (n, h = 165, c. = c(62, 0), l = c(30, 86), power = 1.41532258064516, 
          fixup = TRUE, gamma = NULL, alpha = 1, ...) 
{
  if (!is.null(gamma)) 
    warning("'gamma' is deprecated and has no effect")
...
col.brown <- function (n, h = 20, c. = c(80, 5), l = c(35, 95), power = 0.6, 
                       fixup = TRUE, gamma = NULL, alpha = 1, ...) 
{
  if (!is.null(gamma)) 
    warning("'gamma' is deprecated and has no effect")
...
col.blue <- col.blue(3)
col.green <- col.green(3)
col.brown <- col.brown(3)
...
#pdf(file="HansenSoil_Plots4.pdf", width=11, height=12)
...
mat <- matrix(data = c(1,0, 2, 3, 0, 4, 
                       5, 0, 6, 7, 0, 8,
                       9, 10, 11, 12, 13, 14), ncol=6, nrow=3, byrow=TRUE)
pdf(file="HansenSoil_Plots4.pdf", width=10, height=6)
lay <- layout(mat=mat, widths=c(6.25,1,5, 6.25,1,5,
                                6.25,1,5, 6.25,1,5,
                                6.25,1,5, 6.25,1,5),
              heights=c(3,3, 1.5))
...
plot(x=tempData$Distance, y=tempData$d15N.x, type="p", pch = 20, cex=pt, col=col.blue[2], 
      bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N", sep="")),
     xlab="", xlim=xlim.L, ylim<- c(1, 14), lty=stream.0, cex.lab=cex.lab)



points(x=tempData$Distance, y=tempData$d15N.x, pch = 20, cex=2, col=col.blue[2])
lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.blue[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.blue[1], lwd=2)
mtext("a.", 3, line=-1, adj=0, font=2, cex=1.5)
axis(2, at=axd15N, cex.axis=1.5, line=-1)
axis(1, at=xaxis.0[2:6])
text(x=10, y=13, labels=labels.1[1], cex=salm.cex, font=2)
mtext("per mil vs. air", 2, cex=low.lab, line = 1.5)
...
plot(x=tempData$Distance, y=tempData$d15N.x, pch = 20, col=col.blue[2],type="p",  cex=pt, 
       bty="n", xaxs="i", axes=F, ylab="", xlab="", xlim=xlim.R,ylim<- c(1, 14),lty=stream.0)
lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col=col.blue[1], type='o',lwd=lines.lwd, cex=lines.cex )
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type="n", lty=5, errbar.col = col.blue[1], lwd=errbar.lwd)
axis(1, at=xaxis.0[2:6])
text(x=10, y=13, labels=labels.1[2], cex=salm.cex, font=2)
...
plot(x=tempData$Distance, y=tempData$d13C, type='p',pch = 20, cex=pt, col=col.green[2],bty="n", xaxs="i", axes=F,
     ylab= expression(paste(delta^13, "C", sep="")),  xlab="", 
     xlim=xlim.L, ylim = c(-29.25, -24.5), lty=stream.0, cex.lab=cex.lab)
mtext("b.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext("per mil vs. VPDB", 2, cex=low.lab, line = 1.5)


lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.green[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.green[1], lwd=errbar.lwd)
axis(2, at=axd13C, line=-1, cex.axis=cex.lab)
axis(1, at=xaxis.0[2:6])
text(x=10, y=-24.85, labels=labels.1[1], cex=salm.cex, font=2)
...
plot(x=tempData$Distance, y=tempData$d13C,type="p", pch = 20, cex=pt, col=col.green[2], 
...
lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col=col.green[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type="n", lty=5, errbar.col = col.green[1], lwd=2)
axis(1, at=xaxis.0[2:6])
axis(1, at=xaxis.0[2:6])
text(x=10, y=-24.85, labels=labels.1[2], cex=salm.cex, font=2)
...
plot(x=tempData$Distance, y=tempData$d15N, type='p',pch = 20, cex=pt, col=col.blue[2], bty="n", xaxs="i", axes=F,
     ylab= "",  xlab="", 
     xlim=xlim.L, ylim = c(-1, 47), lty=stream.0, cex.lab=cex.lab)
mtext("c.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext(expression(paste("per mil vs. air")), 2, cex=low.lab, line = 1.25)
mtext(expression(paste(delta^15, "N ", NH[4]^" +")), 2, cex=1.15, line = 2.75)


lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.blue[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.blue[1], lwd=2)
axis(2, at=axd15NNH4, line=-1, cex.axis=1.5)
axis(1, at=xaxis.0[2:6])
...
plot(x=tempData$Distance, y=tempData$d15N,type="p", pch = 20, cex=pt, col=col.blue[2], 
     bty="n", xaxs="i", axes=F,  ylab="",
...
legend(x=5, y=35, legend=c("Data", "Predicted Value"), 
       col=c(col.blue[2], col.blue[1]), lty= c(0, 1), pch=c(16,1), bty="o", lwd=c(2,2), cex=1)
...
plot(x=tempData$Distance, y=tempData$C.N, type='p',pch = 20, cex=pt, col=col.green[2],bty="n", xaxs="i", axes=F,
     ylab= "C:N",  xlab="", 
     xlim=xlim.L, ylim = c(9,20), lty=stream.0, cex.lab=cex.lab)
mtext("d.", 3, line=-1, adj=0, font=2, cex=1.5)


lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.green[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.green[1], lwd=2)
axis(2, at=axdC.N, line = -1, cex.axis=1.5)
axis(1, at=xaxis.0[2:6])
...
plot(x=tempData$Distance, y=tempData$C.N,type="p", pch = 20, cex=pt, col=col.green[2], 
...
plot(x=seq(0,20,1), y=seq(0,20,1), xlim = xlim.L, ylim=c(-20,30), type='l', bty="n", xaxs="i",
     axes=F, ylab="", xlab=xaxis.1[1], col=col[4], lwd=3, cex.lab=cex.lab, font.lab=2)
axis(1, at=xaxis.1[2:6], cex.axis=1.5, labels = c("1", "3 ", "6", "10","20" ))

par(mar=c(4,0,0,0))

plot(x=c(0,1,5,6), y=c(0,-20,-20,0), xlim = c(0,6), ylim=c(-20,30), type='l', bty="n", xaxs="i",
     axes=F, ylab="", xlab="", col=col[4], lwd=3)
axis(1, at=xaxis.0[2:6])
lines(x=c(1,5), y=c(-20,-20), col=col[1], lwd=4)
...
plot(x=c(0,1,5,6), y=c(0,-20,-20,0), xlim = c(0,6), ylim=c(-20,30), type='l', bty="n", xaxs="i",
     axes=F, ylab="", xlab="", col=col[4], lwd=3)
axis(1, at=xaxis.0[2:6], cex.axis = 1.5, labels = c("1", "3 ", "6", "10","20" ))
lines(x=c(1,5), y=c(-20,-20), col=col[1], lwd=4)
...
mat <- matrix(data = c(1,0, 2, 3, 0, 4, 
                       5, 0, 6, 7, 0, 8,
                       9, 0, 10, 11, 0, 12,
                       13, 14, 15, 16, 17, 18), ncol=6, nrow=4, byrow=TRUE)
pdf(file="HansenSoil_Plots4.pdf", width=10, height=8)
lay <- layout(mat=mat, widths=c(6.25,1,5, 6.25,1,5,
                                6.25,1,5, 6.25,1,5,
                                6.25,1,5, 6.25,1,5,
                                6.25,1,5, 6.25,1,5),
...
plot(x=tempData$Distance, y=tempData$NH4_Conc, type='p',pch = 20, cex=pt, col=col.brown[2],bty="n", xaxs="i", axes=F,
     ylab= expression(paste(NH[4]^" +")),  xlab="", 
     xlim=xlim.L, ylim = c(-20,350), lty=stream.0, cex.lab=cex.lab)
mtext("e.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext(expression(paste( mu,"g  N ", g^-1, " dry soil")), 2, cex=low.lab, line = 1.5)
text(x=10, y=335, labels=labels.1[1], cex=salm.cex, font=2)

lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.brown[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.brown[1], lwd=2)
axis(2, at=axNH4, line=-1, cex.axis=1.5)
axis(1, at=xaxis.0[2:6])
text(x=10, y=75, labels=labels.0[1], cex=1.75, font=2)
...
plot(x=tempData$Distance, y=tempData$NH4_Conc,type="p", pch = 20, cex=pt, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
     xlab="", xlim=xlim.R, ylim = c(-20,350), lty=stream.0, cex.lab=cex.lab)



text(x=10, y=335, labels=labels.1[2], cex=salm.cex, font=2)

lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col=col.brown[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type="n", lty=5, errbar.col = col.brown[1], lwd=2)
axis(1, at=xaxis.0[2:6], cex.axis=1.5)
text(x=10, y=12700, labels=labels.0[2], cex=1.75, font=2)

legend(x=6, y=250, legend=c("Data", "Predicted Value"), 
       col=c(col.brown[2], col.brown[1]), lty= c(0, 1), pch=c(16,1), bty="o", lwd=c(2,2), cex=1)
...
plot(x=tempData$Distance, y=tempData$NO3_Conc, type='p',pch = 20, cex=cex.lab, col=col.brown[2], bty="n", xaxs="i", axes=F,
     ylab= expression(paste(NO[3]^"- ")),  xlab="", 
     xlim=xlim.L, ylim = c(-5,35), lty=stream.0, cex.lab=lines.cex, lwd=lines.lwd)
text(x=10, y=35, labels=labels.1[1], cex=salm.cex, font=2)


mtext("f.", 3, line=-1, adj=0, font=2, cex=1.5)
lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.brown[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.brown[1], lwd=2)
axis(2, at=axNO3, line=-1, cex.axis=1.5, labels = c("0", "", "10", "","20", "", "30" ))
axis(1, at=xaxis.0[2:6])
mtext(expression(paste( mu,"g  N ", g^-1, " dry soil")), 2, cex=low.lab, line = 1.5)
...
plot(x=tempData$Distance, y=tempData$NO3_Conc,type="p", pch = 20, cex=pt, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
     xlab="", xlim=xlim.R, ylim = c(-5,30), lty=stream.0, cex.lab=cex.lab)
...
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type="n", lty=5, errbar.col = col.brown[1], lwd=2)
axis(1, at=xaxis.0[2:6], cex.axis=1.5)
text(x=2, y=35, labels=labels.1[2], cex=salm.cex, font=2)
#axis(2, at=axNO3, line=-1, cex.axis=1.5)
...
plot(x=tempData$Distance, y=tempData$NetMin, type='p',pch = 20, cex=pt, col=col.brown[2],bty="n", xaxs="i", axes=F,
     ylab= "Net Mineralization",  xlab="", 
     xlim=xlim.L, ylim = c(-1,11), lty=stream.0, cex.lab=cex.lab)
mtext("g.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext(expression(paste(mu,"g  N ", g^-1, " dry soil ", d^-1)), 2, cex=low.lab, line = 1.5)

lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.brown[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.brown[1], lwd=2)
axis(2, at=axMin, line=-1, cex.axis=1.5)
axis(1, at=xaxis.0[2:6])
...
plot(x=tempData$Distance, y=tempData$NetMin,type="p", pch = 20, cex=pt, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab="",
     xlab="", xlim=xlim.R, ylim = c(-1,11), lty=stream.0, cex.lab=cex.lab)
...
plot(x=tempData$Distance, y=tempData$NetNit, type='p',pch = 20, cex=pt, col=col.brown[2],bty="n", xaxs="i", axes=F,
     ylab= "Net Nitrification ",  xlab="", 
     xlim=xlim.L, ylim = c(-1,11), lty=stream.0, cex.lab=cex.lab)
mtext("h.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext(expression(paste(mu,"g  N ", g^-1, " dry soil ", d^-1)), 2, cex=low.lab, line = 1.5)
...
plot(x=tempData$Distance, y=tempData$NetNit,type="p", pch = 20, cex=pt, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab="",
...
plot(x=tempData$Distance, y=tempData$OrgN, type='p',pch = 20, cex=pt, col=col.green[2],bty="n", xaxs="i", axes=F,
     ylab= "Organic Nitrogen",  xlab="", 
     xlim=xlim.L, ylim = c(0,8000), lty=stream.0, cex.lab=cex.lab)
mtext("i.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext(expression(paste(mu,"g  N ", mg^-1, " dry soil")), 2, cex=low.lab, line = 1.5)

lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.green[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.green[1], lwd=2)
axis(2, at=axOrgN, line = -1, cex.axis=1.5)
axis(1, at=xaxis.0[2:6])
...
plot(x=tempData$Distance, y=tempData$OrgN,type="p", pch = 20, cex=pt, col=col.green[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
...
axGW
plot(x=tempData$Distance, y=tempData$GW, type='p',pch = 20, cex=pt, col=col.green[2], bty="n", xaxs="i", axes=F,
     ylab= "Gravimetric Water",  xlab="", 
     xlim=xlim.L, ylim = c(0,7), lty=stream.0, cex.lab=cex.lab)
mtext("j.", 3, line=-1, adj=0, font=2, cex=1.5)
mtext("Content", 2, cex=1.15, line = 1.25)

lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.green[1], type='o', lwd=lines.lwd, cex=lines.cex)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
       yminus=tempData.1$lwr, add=T, type= "n" , lty=5, errbar.col = col.green[1], lwd=2)
axis(2, at=axGW, line = -1, cex.axis=1.5)
axis(1, at=xaxis.0[2:6])
...
plot(x=tempData$Distance, y=tempData$GW,type="p", pch = 20, cex=pt, col=col.green[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
     xlab="", xlim=xlim.R, ylim = c(0,7), lty=stream.0, cex.lab=cex.lab)
