...
plot(x=tempData$Distance, y=tempData$d15N.x, type="p", pch = 20, cex=1.5, col=col.blue[2], 
      bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N", sep="")),
     xlab="", xlim=xlim.L, ylim<- c(1, 14), lty=stream.0, cex.lab=1.5)



points(x=tempData$Distance, y=tempData$d15N.x, pch = 20, cex=1.5, col=col.blue[2])
lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.blue[1], type='o', lwd=2)
...
plot(x=tempData$Distance, y=tempData$d15N.x, pch = 20, col=col.blue[2],type="p",  cex=1.5, 
...
plot(x=tempData$Distance, y=tempData$d13C, type='p',pch = 20, cex=1.5, col=col.green[2],bty="n", xaxs="i", axes=F,
     ylab= expression(paste(delta^13, "C", sep="")),  xlab="", 
     xlim=xlim.L, ylim = c(-29.25, -24.5), lty=stream.0, cex.lab=1.5)
mtext("b.", 3, line=-1, adj=0, font=2)
mtext("per mil vs. VPDB", 2, cex=0.7, line = 1.5)


lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.green[1], type='o', lwd=2)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
...
plot(x=tempData$Distance, y=tempData$d13C,type="p", pch = 20, cex=1.5, col=col.green[2], 
...
plot(x=tempData$Distance, y=tempData$d15N, type='p',pch = 20, cex=1.5, col=col.blue[2], bty="n", xaxs="i", axes=F,
     ylab= expression(paste(delta^15, "N ", NH[4]^" +")),  xlab="", 
     xlim=xlim.L, ylim = c(-1, 47), lty=stream.0, cex.lab=1.5)
...
plot(x=tempData$Distance, y=tempData$d15N,type="p", pch = 20, cex=1.5, col=col.blue[2], 
     bty="n", xaxs="i", axes=F,  ylab="",
...
plot(x=tempData$Distance, y=tempData$NH4_Conc, type='p',pch = 20, cex=1.5, col=col.brown[2],bty="n", xaxs="i", axes=F,
     ylab= expression(paste(NH[4]^" +")),  xlab="", 
     xlim=xlim.L, ylim = c(-20,350), lty=stream.0, cex.lab=1.5)
mtext("d.", 3, line=-1, adj=0, font=2)
mtext(expression(paste( mu,"g  N ", g^-1, " dry soil")), 2, cex=0.7, line = 1.5)


lines(sort(tempData.1$Distance), tempData.1$fit[order(tempData.1$Distance)], col= col.brown[1], type='o', lwd=2)
errbar(x=tempData.1$Distance, y=tempData.1$fit, yplus=tempData.1$upr, 
...
plot(x=tempData$Distance, y=tempData$NH4_Conc,type="p", pch = 20, cex=1.5, col=col.brown[2], 
...
legend(x=1, y=300, legend=c("Data", "Predicted Value"), 
...
plot(x=tempData$Distance, y=tempData$NO3_Conc, type='p',pch = 20, cex=1.5, col=col.brown[2], bty="n", xaxs="i", axes=F,
     ylab= expression(paste(NO[3]^"- ")),  xlab="", 
     xlim=xlim.L, ylim = c(-5,30), lty=stream.0, cex.lab=1.5)
...
plot(x=tempData$Distance, y=tempData$NO3_Conc,type="p", pch = 20, cex=1.5, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
...
plot(x=tempData$Distance, y=tempData$NetMin, type='p',pch = 20, cex=1.5, col=col.brown[2],bty="n", xaxs="i", axes=F,
     ylab= "Net Mineralization",  xlab="", 
     xlim=xlim.L, ylim = c(-1,11), lty=stream.0, cex.lab=1.5)
...
plot(x=tempData$Distance, y=tempData$NetMin,type="p", pch = 20, cex=1.5, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab="",
...
plot(x=tempData$Distance, y=tempData$NetNit, type='p',pch = 20, cex=1.5, col=col.brown[2],bty="n", xaxs="i", axes=F,
...
plot(x=tempData$Distance, y=tempData$NetNit,type="p", pch = 20, cex=1.5, col=col.brown[2], 
     bty="n", xaxs="i", axes=F,  ylab="",
     xlab="", xlim=xlim.R, ylim = c(-1,11), lty=stream.0)
...
plot(x=tempData$Distance, y=tempData$OrgN, type='p',pch = 20, cex=1.5, col=col.green[2],bty="n", xaxs="i", axes=F,
...
plot(x=tempData$Distance, y=tempData$OrgN,type="p", pch = 20, cex=1.5, col=col.green[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
...
axGW
plot(x=tempData$Distance, y=tempData$GW, type='p',pch = 20, cex=1.5, col=col.green[2], bty="n", xaxs="i", axes=F,
...
plot(x=tempData$Distance, y=tempData$GW,type="p", pch = 20, cex=1.5, col=col.green[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
...
plot(x=tempData$Distance, y=tempData$C.N, type='p',pch = 20, cex=1.5, col=col.green[2],bty="n", xaxs="i", axes=F,
     ylab= "C:N",  xlab="", 
...
plot(x=tempData$Distance, y=tempData$C.N,type="p", pch = 20, cex=1.5, col=col.green[2], 
     bty="n", xaxs="i", axes=F,  ylab=expression(paste(delta^15, "N (per mil vs. air)", sep="")),
...
plot(x=seq(0,20,1), y=seq(0,20,1), xlim = xlim.L, ylim=c(-20,30), type='l', bty="n", xaxs="i",
     axes=F, ylab="", xlab=xaxis.1[1], col=col[4], lwd=3, cex.lab=1.25, font.lab=2)
